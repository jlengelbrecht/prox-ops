#!/usr/bin/env bash
#
# Heartbeat producer for the Bazzite RTX 5090 edge worker.
#
...
#   EDGE_NODE_ID              placement name (default bazzite-5090)
...
#   NVIDIA_SMI                nvidia-smi path (default: /usr/bin/nvidia-smi)
...
NODE_ID="${EDGE_NODE_ID:-bazzite-5090}"
